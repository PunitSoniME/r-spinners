...
const WobblingSpinner10Wrapper = styled.div.attrs(
  props => ({
  ...
  width: calc(100px - 14px);
    ...
    border-radius: 50px;
    background: 
      radial-gradient(farthest-side, #0000 calc(100% - 15px), ${props => props.bgColor} calc(100% - 14px) 99%,#0000) left,
      radial-gradient(farthest-side, #0000 calc(100% - 15px), ${props => props.bgColor} calc(100% - 14px) 99%,#0000) right;
