...
const RoundedSpinner5Wrapper = styled.div.attrs(
  props => ({
    color: props["color"],
  ...
  -webkit-mask:
    repeating-conic-gradient(#0000 0deg, ${props => props.color} 1deg 70deg, #0000 71deg 90deg),
    radial-gradient(farthest-side, #0000 calc(100% - var(--b) - 1px), ${props => props.color} calc(100% - var(--b)));
