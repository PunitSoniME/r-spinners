...
const ContinuousSpinner7Wrapper = styled.div.attrs(
  props => ({
  ...
  -webkit-mask:linear-gradient(90deg, ${props => props.color} 70%, #0000 0) left/20% 100%;
  background:
    linear-gradient(${props => props.color} 0 0) left -25% top 0 /20% 100% no-repeat
    ${props => props.bgColor};
