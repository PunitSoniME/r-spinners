...
const ContinuousSpinner10Wrapper = styled.div.attrs(
  props => ({
  ...
  background: linear-gradient(${props => props.color} 0 0) left -40px top 0/40px 100% no-repeat ${props => props.bgColor};
  -webkit-mask:
