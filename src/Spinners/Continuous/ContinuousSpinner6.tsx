...
const ContinuousSpinner6Wrapper = styled.div.attrs(
  props => ({
  ...
  background: 
      radial-gradient(circle 10px, ${props => props.color} 95%, #0000) right/calc(200% + 20px) 100%,
      linear-gradient(${props => props.color} 0 0) center/100% 6px; 
  background-repeat: no-repeat; 
  -webkit-mask: radial-gradient(circle 4px, #0000 93%, ${props => props.color}) right/calc(200% + 20px) 100%;
