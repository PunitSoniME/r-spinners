...
const ClassicSpinner9Wrapper = styled.div.attrs(props => ({
	text: props['text'],
	colors:
	...
	overflow: hidden;
	text-shadow: 0 0 ${props => props.colors[0]},
		${props => props.text.length + 1}ch 0 ${props => props.colors[1]},
		${props => props.text.length + 2}ch 0 ${props => props.colors[2]},
		${props => props.text.length + 3}ch 0 ${props => props.colors[3]},
		${props => props.text.length + 4}ch 0 ${props => props.colors[0]};
